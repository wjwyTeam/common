...
import com.unis.common.constant.ResponseMessageConstant;
...
public class ResponseWrapper {
     ...
     * @param data     传输数据
     */
    private ResponseWrapper(StatusEnum status, Integer infoCode, String msg, Object data) {
        this.msg = msg;
        this.status = status;
    ...
    public static ResponseWrapper success(Integer infoCode, String info, Object data) {
